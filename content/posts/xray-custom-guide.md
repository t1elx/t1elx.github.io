...
> **Риски:** Возможны разрывы в онлайн-играх.
...
**Что делает:** Перед каждым открытием нового исходящего соединения «замирает» на случайное время от 10 до 50 мс.

**Зачем:** Сбивает автоматизированные системы анализа (DPI), которые ищут фиксированные тайминги прокси-протоколов. Это имитирует естественную задержку обработки запроса (RTT).

2. **Принудительное ограничение жизни сессии**

**Что делает:** Каждое соединение живет случайный срок от 3 до 12 минут, после чего принудительно разрывается.

**Зачем:** Предотвращает накопление аномально большого объема трафика в рамках одной TCP-сессии. Для DPI это выглядит как серия обычных запросов, а не один бесконечный «подозрительный» туннель.
