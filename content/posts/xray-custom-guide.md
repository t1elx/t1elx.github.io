...
<b>Внесение случайной задержки (Jitter)</b>
   
<b>Что делает:</b> Перед каждым открытием нового исходящего соединения «замирает» на случайное время от 10 до 50 мс.

<b>Зачем:</b> Сбивает автоматизированные системы анализа (DPI), которые ищут фиксированные тайминги прокси-протоколов. Это имитирует естественную задержку обработки запроса (RTT).

<b>Принудительное ограничение жизни сессии</b>

<b>Что делает:</b> Каждое соединение живет случайный срок от 3 до 12 минут, после чего принудительно разрывается.

<b>Зачем:</b> Предотвращает накопление аномально большого объема трафика в рамках одной TCP-сессии. Для DPI это выглядит как серия обычных запросов, а не один бесконечный «подозрительный» туннель.
